...
def create_csv(base_folder, ods1, ods2, save_path):
    import locale
...
if __name__ == '__main__':
    ...
    base_folder = 'C:/Users/chiar/Desktop/Progetto Bioimmagini/Campioniparticolari/dataset'
    ods1 = 'C:/Users/chiar/Desktop/Progetto Bioimmagini/Campioniparticolari/Campioni particolari/campioni particolari/lista campioni.ods'
    # ods 15 luglio
    ods2 = 'C:/Users/chiar/Desktop/Progetto Bioimmagini/Campioniparticolari/Campioni particolari/Dati campioni particolari.ods'
    save_path = './open.csv'
    save_excel_file = './synthesis_new.xlsx'

    create_csv(base_folder, ods1, ods2, save_path)
    create_synthesis_file(save_path, save_excel_file)
