...
datasetcsv = pd.read_csv('./dataset_files/open_new_copia.csv', names=['data', 'id', 'image', 'label'])
label_group = datasetcsv.groupby(['label'])
lip = label_group.get_group('lipemico')  # campioni lipemici
id_lip = lip.groupby(['id'])

augmented_path = 'C:/Users/chiar/Desktop/Progetto_Bioimmagini/Campioniparticolari/augmented_samples/'
# crea se non c'è
...
dcsv.to_csv('augmented_dataset.csv', index=False, header=False)
# 1536 righe = 984 + (69*8)
# 192 id = 123 + 69
